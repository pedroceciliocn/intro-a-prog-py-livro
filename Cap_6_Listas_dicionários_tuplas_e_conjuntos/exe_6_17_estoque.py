...
e só então efetue a baixa do estoque.
"""
...
print("Vendas:\n")
while True:
     produto = input("Dê o nome do produto (fim para sair): ")
     if produto == "fim":
        break
     if produto in estoque:
        quantidade = int(input("Dê a quantidade: "))
        ...
        print("Nome de produto inválido ou inexistente no estoque")
